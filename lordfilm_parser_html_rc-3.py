...
class LordFilmParser:
            ...
            try:
                ...
                for idx, item in enumerate(soup.select('.th-item')):
                    ...
                    all_movies.append({
                        ...
                        'rating_avg': (
                            None
                            if rating_kp is None and rating_imdb is None  # Оба None → None
                            else round(
                                ((rating_kp if rating_kp is not None else 6) +
                                 (rating_imdb if rating_imdb is not None else 6)) / 2,
                                1
                            )
                        )
                    })
    ...
    def _fetch_movie_details(self, movie_url: str) -> Dict:
        """Fetch additional details from movie page"""
        try:
            ...
            <div class="movie">
                ...
                <div class="movie-info">
                    ...
                    <div class="movie-meta">
                        ...
                        <strong>Rating:</strong> {movie['rating_avg'] or 'N/A'}
                    </div>
...
if __name__ == "__main__":
    ...
    for sort_criteria, filename in [('kp', 'top_kp.json'),
        ...
        # Save HTML only for avg rating
        if sort_criteria == 'avg':
